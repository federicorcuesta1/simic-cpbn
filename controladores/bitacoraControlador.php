<?php
    ...
    class bitacoraControlador extends mainModel{
        //funcion controladora para manejar la bitacora de home
        public function listado_bitacora_controlador($registros){
            ...
            while($rows=$datos->fetch()){
                ...
                if($rows['BitacoraTipo']=="Administrador"){
                    ...
                    $datosU=mainModel::ejecutar_consulta_simple("SELECT ContabNombre, ContabApellido FROM contab WHERE CuentaCodigo='".$rows['CuentaCodigo']."'");
                    $datosU=$datosU->fetch();
                    $NombreCompleto=$datosU['ContabNombre']." ".$datosU['ContabApellido'];
                }
                ...
                echo '
                    <div class="cd-timeline-block">
                        ...
                        <div class="cd-timeline-content">
                            ...
                            <p class="text-center">
                                <i class="zmdi zmdi-timer zmdi-hc-fw"></i> Inicio Sesión: <em>'.$rows['BitacoraHoraInicio'].'</em> &nbsp;&nbsp;&nbsp;
                                <i class="zmdi zmdi-time zmdi-hc-fw"></i> Final Sesión: <em>'.$rows['BitacoraHoraFinal'].'</em>
                            </p>
