...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> USUARIO ADMINISTRATIVOS </h1>
    </div>
    <p class="lead">Esta pagina es para crear los usuarios administrativos que manejaran el sistema; debemos tener en cuenta los permisos y el perfil del usuario.</p>
</div>
                            ...
                            <div class="col-xs-12 col-sm-6">                                
                                <?php if($_SESSION['privilegio_simic']==1): ?>
                                    ...
                                    <?php 
                                        ...
                                        if($_SESSION['privilegio_simic']<=2):
                                    ?>
