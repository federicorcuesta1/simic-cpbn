...
<div class="container-fluid">
	...
	<p class="lead">Estos son los datos registrados de la cuenta de usuario, puede hacer la actualización si estos estan incorrectos.</p>
</div>

<?php
	$datos=explode("/", $_GET['views']);

	if(isset($datos[1]) && ($datos[1]=="admin" || $datos[1]=="contab")):
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<form action="<?php echo SERVERURL; ?>ajax/cuentaAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                <?php 
                    if($_SESSION['codigo_cuenta_simic']!=$campos['CuentaCodigo']){
                        if($_SESSION['tipo_simic']!="Administrador" || $_SESSION['privilegio_simic']<1 || $_SESSION['privilegio_simic']>2){
		    	...
		    	<fieldset>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
                            ...
                            <?php if($_SESSION['tipo_simic']=="Administrador" &&  $_SESSION['privilegio_simic']==1 && $campos['id']!=1): ?>
							<div class="col-xs-12 col-sm-6">
								<div class="form-group">
									...
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsEstado-up" <?php if($campos['CuentaEstado']=="Inactivo"){ echo 'checked=""'; } ?> value="Inactivo"  >
		    	...
		    	<fieldset>
		    		...
		    		<p>
                    Puedes realizar el cambio de contraseña en este espacio, solo debes colocar la misma en los dos campos.
		    		</p>
		    		<div class="container-fluid">
		    			<div class="row">
		    				<div class="col-xs-12 col-sm-6">
		    		...
		    		<?php if($_SESSION['tipo_simic']=="Administrador" &&  $_SESSION['privilegio_simic']==1 && $campos['id']!=1 && $campos['CuentaTipo']=="Administrador" && $datos[1]=="admin"): ?>
		    		<div class="col-xs-12 col-sm-6">
                        <div class="form-group label-floating">
                            <label class="control-label">Tipo Usuario *</label>
                            <input class="form-control" type="text" name="tipo-up" value="" maxlength="50">
                    	</div>
                    </div>
                    <?php endif; ?>
		    	</fieldset>
